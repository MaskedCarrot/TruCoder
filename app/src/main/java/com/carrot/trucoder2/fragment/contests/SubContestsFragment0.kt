...
import com.carrot.trucoder2.databinding.FragmentSubContests0Binding
import com.carrot.trucoder2.viewmodel.MainActivityViewModel
import kotlinx.android.synthetic.main.fragment_sub_contests0.*


class SubContestsFragment0 : Fragment(R.layout.fragment_sub_contests0) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getAllContests().observe(viewLifecycleOwner , Observer {
        ...
        viewModel.getAllRunningContests().observe(viewLifecycleOwner , Observer {
