...
class SubContestsFragment1() : Fragment(R.layout.fragment_sub_contests0) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getCodechefContests().observe(viewLifecycleOwner , Observer {
        ...
        viewModel.getAllRunningCCContests().observe(viewLifecycleOwner , Observer {
