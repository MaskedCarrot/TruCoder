...
class SubContestsFragment3 : Fragment(R.layout.fragment_sub_contests0) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getGoogleContests().observe(viewLifecycleOwner , Observer {
        ...
        viewModel.getAllRunningGContests().observe(viewLifecycleOwner , Observer {
