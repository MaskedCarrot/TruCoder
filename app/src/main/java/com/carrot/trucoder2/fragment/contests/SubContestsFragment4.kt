...
class SubContestsFragment4 : Fragment(R.layout.fragment_sub_contests0) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getTopCoderContests().observe(viewLifecycleOwner , Observer {
        ...
        viewModel.getAllRunningTContests().observe(viewLifecycleOwner , Observer {
