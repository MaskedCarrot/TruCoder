...
class SubContestsFragment6() : Fragment(R.layout.fragment_sub_contests0) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getAtCoderContests().observe(viewLifecycleOwner , Observer {
        ...
        viewModel.getAllRunningACContests().observe(viewLifecycleOwner , Observer {
